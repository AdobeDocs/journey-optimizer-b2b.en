...
description: Reused section about using components and content elements for content authoring in Journey Optimizer B2B Prime
---
...
1. To start your content design, drag an item from the **[!UICONTROL Structures]** and drop it onto the canvas.
   ...
   For more information about using and formatting these components, see _[Structure Components](../prime/content/structure-components.md)_.
...
1. Expand the **[!UICONTROL Contents]** section and add as many content components as you need into one or more structure components.
   ...
   * [Container](../prime/content/content-components.md#container)
   * [Button](../prime/content/content-components.md#button)
   * [Text](../prime/content/content-components.md#text)
   * [Divider](../prime/content/content-components.md#divider)
   * [Image](../prime/content/content-components.md#image)
   * [Social](../prime/content/content-components.md#social)
   * [Form](../prime/content/content-components.md#form) (landing pages only)
