...
description: For a send email action node in a journey, create new emails or duplicate existing ones to use for targeted communications in Journey Optimizer B2B Edition.
...
>[!NOTE]
>
>If you are sending an email for the first time, make sure that the email channel is configured. To learn more, see [Protocols for tracking and email delivery](../start/email-protocols.md).
>
>For details about how email consent preferences are evaluated at delivery time, see [Consent preferences](./channels-consent-preferences.md). 
...
1. _(Account journeys only)_ For the _[!UICONTROL Action on]_ target, choose **[!UICONTROL People]**.

1. For the action, choose **[!UICONTROL Send email]**.

1. Click **[!UICONTROL Create email]**. 

   ![Take an action - send an email](assets/journey-node-send-email.png){width="500"}

1. In the _Create new email_ dialog, choose to create a new email content asset or duplicate an existing email content asset.

    * Choose the **[!UICONTROL New email]** option when you want to create an email using an empty canvas or an email template.

       ![Create new email dialog - new email](assets/create-new-email.png){width="400"}

       * Enter a unique **[!UICONTROL Name]** for the email and a **[!UICONTROL Subject line]**.

       * Click **[!UICONTROL Create]**.

    * Choose the **[!UICONTROL Duplicate existing email]** option when you want to create an email using an existing email from the current journey or from another journey.

       You can make changes to the duplicated email according to your objective for the journey node.

       * For **[!UICONTROL Existing email to duplicate]**, click the _Selection_ icon ( ![Selection icon](../assets/do-not-localize/icon-email-select.svg) ) and select the email that you want to duplicate and use for the journey node.

          You can filter the list of emails by entering a text string in the search field to match the email name. Select the checkbox for the email that you want to duplicate and click **[!UICONTROL Select]**. 

          ![Select email](assets/create-new-email-duplicate-select-email.png){width="600" zoomable="yes"}

       * Enter a unique **[!UICONTROL Name]** for the email and a **[!UICONTROL Subject line]**.

         ![Create new email dialog - duplicate existing email](assets/create-new-email-duplicate.png){width="400"}

       * Click **[!UICONTROL Create]**.

1. Click **[!UICONTROL Edit email]** to define the email [settings](#email-settings) and [content](./email-authoring.md).

   ![Send email journey node - edit email](assets/journey-node-send-email-edit-email.png){width="500"}
...
| [!UICONTROL Disable open tracking] | Select the checkbox when you do not want to track email open activity. With the function disabled, email open activity counts are incremented only when a unique person opens the email. You can [manage email content link tracking](./email-authoring.md#edit-linked-url-tracking) when you design the email body content. |
