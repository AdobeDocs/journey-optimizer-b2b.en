...
Advanced HTML mode provides an advanced HTML view that lets experienced users directly view and edit the raw source code for email template content. This mode is ideal when you want to insert sophisticated expressions, such as conditional logic, directly into the source. It is also helpful for making structural adjustments that go beyond what the visual design tools expose.
...
Before you use _Advanced HTML mode_ for [email template authoring](./email-template-authoring.md), make sure that you understand the following limitations:

* **No validation** — The _Advanced HTML mode_ HTML editor does not perform syntax checking or layout verification. Review your code carefully before saving.
...
<!-- ![Expert mode showing raw HTML source of the email content](./assets/email-template-html-view.png){width="800" zoomable="yes"} -->

### Access expert mode

Advanced HTML mode is accessible from the toolbar at the top of the visual design space.
...
1. In the design space, click the _[!UICONTROL HTML]_ ( ![HTML icon](../assets/do-not-localize/icon-code.svg) ) icon in the toolbar.
   ...
   <!-- ![Click the HTML icon in the email design toolbar](./assets/email-template-html-mode-toolbar.png){width="600" zoomable="yes"} -->
   ...
   <!-- ![Review the expert mode warning and click OK to continue](./assets/email-template-html-mode-warning.png){width="500"} -->
