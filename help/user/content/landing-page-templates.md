...
For an accelerated and improved design process, you can create standalone landimg page templates to standardize your page design and content. Marketing strategists can reuse the pages and adapt them to fit use in campaigns and journeys.
...
You can create an landing page template from the landing page template listing page by clicking **[!UICONTROL Create template]** at the top right.

1. In the dialog, enter a unique **[!UICONTROL Name]** (required) and a useful **[!UICONTROL Description]** (optional).

   ![Enter initial properties for the new landing page template](./assets/templates-create-dialog.png){width="400"}
...
![Choose how you want to start with your landing page template design](./assets/templates-create-design.png){width="800" zoomable="yes"}

After you select the method that you want to use to start your template design, use the visual designer to [author your landing page template content](./email-template-authoring.md).
