...
Relational schemas allow you to create custom data classes. With access to multiple datasets, you can create classes specifically tailored to your data needs. Use [relational schemas](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/schema/relational#) for business entities, such as purchases, licenses, and event registrations, in journey decisions and email personalization. You can select up to 20 schemas and up to 50 fields per schema.
