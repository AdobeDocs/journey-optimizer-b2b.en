...
description: Learn how to comply with GDPR, CCPA, and other privacy regulations in Journey Optimizer B2B Edition, and submit requests using Adobe Privacy Service.
...
[!DNL Adobe Journey Optimizer B2B Edition] provides these privacy tools so that you can meet global data protection requirements. Use [!DNL Privacy Service] to submit and manage access and delete requests for data that [!DNL Journey Optimizer B2B Edition] collects and stores.

You can submit individual requests to access and delete consumer data from [!DNL Adobe Journey Optimizer B2B Edition] in two ways:
...
[!DNL Journey Optimizer B2B Edition] privacy tools help you comply with the regulations through [!DNL Privacy Service]. Each regulation applies if you hold data for people who reside in the associated region.
...
[!DNL Journey Optimizer B2B Edition] supports two privacy request types:
...
![Permissions icon](../assets/do-not-localize/icon_permissions-outline.svg) These steps require the [!DNL Privacy Service] product profile and the following [permissions for your assigned user role in Experience Platform](./user-management.md):
...
To view privacy request jobs in [!DNL Journey Optimizer B2B Edition], expand **[!UICONTROL Privacy]** and select **[!UICONTROL Requests]**.
...
1. Select **[!UICONTROL Create Request]**.

1. For the **[!UICONTROL Job Type]**, select the request type:

   * **[!UICONTROL Access]**

      When you submit an **_access_** request that includes [!DNL Journey Optimizer B2B Edition], [!DNL Privacy Service] returns:

      * [!DNL Marketo Engage] activity associated with the lead.
      * [!DNL Journey Optimizer B2B Edition] activity associated with the person or account.

   * **[!UICONTROL Delete]**

      When you submit a **delete** request for [!DNL Marketo Engage] and [!DNL Journey Optimizer B2B Edition], the following records are removed:

      * The associated lead in [!DNL Marketo Engage].
      * Person and account records created in [!DNL Journey Optimizer B2B Edition].
...
1. For **[!UICONTROL Products]**, select **[!UICONTROL Marketo]**.
   ...
   ![Create GDPR access privacy request for Marketo Engage and Journey Optimizer B2B Edition](./assets/privacy-request-create-gdpr.png){width="450" zoomable="yes"}

   This selection includes data from both [!DNL Journey Optimizer B2B Edition] and your [!DNL Marketo Engage] instance.

1. Scroll to the bottom of the dialog and enter the email address of the person whose data you want to access or delete.

1. To submit the request, select **[!UICONTROL Create]**.
...
| `include` | `marketo` to include both [!DNL Journey Optimizer B2B Edition] and [!DNL Marketo Engage] data |
...
The following example submits a GDPR delete request that includes [!DNL Journey Optimizer B2B Edition] data.
