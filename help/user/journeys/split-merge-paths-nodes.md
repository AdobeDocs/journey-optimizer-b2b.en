...
| | [!UICONTROL Special filters] > [!UICONTROL Has opportunity] | The account is or is not related to an opportunity. Can also be evaluated against one or more of the following opportunity attributes: <li>Amount</li><li>Close date</li><li>Description</li><li>Expected revenue</li><li>Fiscal quarter</li><li>Fiscal year</li><li>Forecast category</li><li>Forecast category name</li><li>Is closed</li><li>Is won</li><li>Last activity date</li><li>Person source</li><li>Name</li><li>Next step</li><li>Probability</li><li>Quantity</li><li>Stage</li><li>Type |
