...
| ---------- | ----- | ----------- |
| Journey Optimizer B2B | Assigned to Buying Group | Solution interest<br/>Additional constraints (optional): <li>Role</li><li>Date of activity</li><br/>Timeout (optional) |
