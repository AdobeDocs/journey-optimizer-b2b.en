...
| Feature | _Variant split paths_ journey nodes | (Previously Beta for account journeys) Marketers can now test variations within an account or person journey by assigning accounts or people to different journey paths based on defined percentages. |
...
| Feature | Sales Insights for Salesforce and Dynamics | Sales team members can now view maturing buying groups and related insights within a Salesforce or Dynamics integration to identify new opportunities. The buying group details like stage, score, and related members are included. [Learn more](../buying-groups/incrm-insights.md) |
| Feature | Activate audience to [!DNL Adobe Target] | You can now activate an audience from an account journey to an external customer audience and push it to [!DNL Adobe Target]. With this integration, you can deliver an audience that is qualified through a journey sequence for a web experience designed in [!DNL Target]. [Learn more](../audiences/target-external-audience.md) |
| Feature | Web engagement dashboard | A new dashboard that provides insights into how web visitors interact with key content. It segments data across account industries and regions to help you understand engagement trends. [Learn more](../dashboards/web-engagement-dashboard.md) |
| Feature | Role Insights dashboard | The new _[!UICONTROL Role Insights]_ dashboard provides insights into how your campaigns and journeys are influencing buying group role acquisition and engagement. [Learn more](../buying-groups/buying-group-role-insights.md) |
| Enhancement | Improved buying group completeness scoring | You can now ensure that buying groups reflect real decision-making with customizable role member thresholds for completeness scoring.  [Learn more](../buying-groups/completeness-scores.md) |
...
| Feature | Person details page | Users can now click a person's name when it is displayed (as a hyperlink) in the Intelligent Dashboard, buying group details page, and account details page. This action opens the associated person details page, with information for the contact, their activity, and top-engaged buying groups. [Learn more](../accounts/person-details.md)|
| Feature | Account and buying group actions | Take actions directly from account details and buying group details pages for timely and intentional engagement. <li>Use the _Send email_ action to send an approved Marketo Engage email to selected account contacts or buying group members. [Learn more](../accounts/account-details.md#send-email) <li>From the buying group details, actions also include _Assign a new member_, _Remove a member_, and _Edit a role_. [Learn more](../buying-groups/buying-group-details.md#members-tab) |
...
| Type | Item | Description |
| ---- | ---- | ----------- |
| Feature | Duplicate account journeys | A duplicate action is now available for account journeys. You can duplicate the details for the account journey, or just a simple skeleton of the flow and path structure. <a href="../journeys/journeys-overview.md#duplicate-journey">Learn more</a> |
...
| Feature | Buying group and account details | View insights at the buying group and account-level to have more context and historical data when you start engaging with a customer.<p>The buying group details include any first-party intent that is detected. <a href="../buying-groups/buying-group-details.md">Learn more</a><p>The account details page highlights the surge in engagement detected intent, so that marketers can alert sales about accounts that are ready for customized sales focused engagement.  <a href="../accounts/account-details.md">Learn more</a>|
| Feature | Journeys overview dashboard | For account journeys, the **[!UICONTROL Overview]** tab provides a comprehensive snapshot of your active journeys, with circle and bar charts that categorize and quantify completions and engagement activities. <a href="../dashboards/journeys-dashboard.md">Learn more</a>|
...
| Type | Item | Description |
| ---- | ---- | ----------- |
| Feature | Conditional content in emails | Personalize your email content based on recipient behavior and profile characteristics at both the account and lead level. <p>As you author an email for your account journey in the email visual design space, use conditional rules to define multiple variants for any content component. <a href="../content/conditional-content.md">Learn more</a> |
| Feature | _Add to List_ and _Remove from list_ people actions in journeys | Use journey actions to add people to or remove people from a static list in a connected Marketo Engage instance, coordinated with your account journey orchestration. <a href="../journeys/action-nodes.md">Learn more</a> |
