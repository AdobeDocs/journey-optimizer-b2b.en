...
| Feature | WhatsApp channel | Marketers can now send WhatsApp messages directly from account journeys through the [!DNL Meta Cloud API]. This feature enables seamless integration of WhatsApp messaging to support journey content channels. [Learn more](../content/whatsapp-authoring.md) |
