...
| Enhancement | Journey node counts | Improved visibility into journey membership counts at the node level. Use this information to validate account progression in a journey. See the cumulative number of accounts that have reached a node. |
