...
_| Enhancement | _Take an action_ journey nodes | Additional actions are now available for the people context of account journey and from a person journey: _Add to Person journey_ and _Remove from Person journey_. |
