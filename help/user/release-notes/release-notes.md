...
| Feature | [Persona Mapping](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/admin/persona-mapping.html#) | Tie account members with established personas with attribute mapping. |
