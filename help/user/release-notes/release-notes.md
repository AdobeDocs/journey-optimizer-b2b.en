...
| Feature | Activate sudience to [!DNL Adobe Target] | You can now activate an audience from an account journey to an external customer audience and push it [!DNL Adobe Target]. With this integration, you can deliver an audience that is qualified through a journey sequence for a web experience designed in [!DNL Target]. [Learn more](../audiences/target-external-audience.md) |
