...
>[!IMPORTANT]
>
>The email address attribute is required and must be populated for proper functionality. By default, the system uses `workEmail.Address`. If you intend to use a different attribute, contact Adobe Support before publishing any journeys to ensure proper configuration.
><br/>
