...
<table style="table-layout:auto">
  <tr style="border: 0;">
    ...
    <td>
      ...
      <strong>Journey content</strong><br/><a href="./content/email-authoring.md">Email authoring</a><br/><a href="./content/ai-assistant-emails.md">AI Assitant for email</a><br/><a href="./content/sms-authoring.md">SMS authoring</a>
    </td>
  </tr>
  <tr style="border: 0;">
        <td>
