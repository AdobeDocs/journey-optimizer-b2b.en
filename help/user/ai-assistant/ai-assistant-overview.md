...
| Account Audiences <br><br>**_Note:_** In the Journey Optimizer B2B Edition context, AI Assistant can only answer audience questions for Account Audiences. In the Experience Platform context, AI Assistant can answer questions only for Person Audiences. | <li>Audience count <li>Audience type (streaming or batch) <li>Creation/modification dates <li>Activation status <li>Member count <li>Duplicate audiences <li>Name and ID search | <li>Audience overlaps <li>Audience activation <li>Audit <li>Create/modification <li>Labels <li>Member qualification trends |
