...
1. Select the _Styles_ tab on the right and click **[!UICONTROL Add custom CSS]**. 
   ...
   ![Access the body styles](../../user/content/assets/email-body-styles.png){width="800" zoomable="yes"}
...
1. Enter your CSS code in the editor.
   ...
   ![Enter custom CSS in the editor](../../user/content/assets/content-design-add-custom-css.png){width="450"}
...
1. Click **[!UICONTROL Save]** to save the custom CSS.
   ...
   ![Custom CSS applied to content](../../user/content/assets/email-body-custom-css-applied.png){width="600" zoomable="yes"}
