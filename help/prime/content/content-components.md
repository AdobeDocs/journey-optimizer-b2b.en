...
description: Design emails, landing pages, and fragments with content components - add buttons, text, images, forms, and containers in Journey Optimizer B2B Prime.
...
The **[!UICONTROL Contents]** section of the Components library displays the available content components:
...
![Content component toolbar](../../user/assets/do-not-localize/toolbar-content.png){width="450"}
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-text-styles.png" alt="Change text style tool"></td>
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-horizontal-alignment.png" alt="Horizontal alignment tool"></td>
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-create-list.png" alt="Create list tool"></td>
...
<table>
    ...
    <tr>
        <td><img width="60px" src="../../user/assets/do-not-localize/toolbar-button-set-heading.png" alt="Set heading tool"></td>
...
<table>
    ...
    <tr>
        <td><img width="60px" src="../../user/assets/do-not-localize/toolbar-button-font-size.png" alt="Font size tool"></td>
...
<table>
    ...
    <tr>
        <td><img width="200px" src="../../user/assets/do-not-localize/toolbar-button-font-color.png" alt="Font color tool"></td>
...
<table>
    ...
    <tr>
        <td><img width="200px" src="../../user/assets/do-not-localize/toolbar-button-insert-link.png" alt="Insert link tool"></td>
...
<table>
    ...
    <tr>
        <td><img width="80px" src="../../user/assets/do-not-localize/toolbar-button-remove-link.png" alt="Remove link tool"></td>
...
| Tool | Name | Usage |
| ---- | ---- | ----- |
| ![Add personalization](../../user/assets/do-not-localize/toolbar-button-add-personalization.png){width="40"} | Add personalization|  Use the personalization editor to insert personalization tokens in the component content. [Learn more](./email-authoring.md#personalize-content) |
| ![Show the source code](../../user/assets/do-not-localize/toolbar-button-show-source-code.png){width="40"} | Show the source code| Display the HTML source code for the component in a read-only popup. <br/>![Show HTML code](../../user/content/assets/content-components-show-source-code.png){width="200"} |
...
1. In the **[!UICONTROL Components]** library, grab the _Drag handle_ ![Drag handle](../../assets/do-not-localize/icon-drag-handle.svg) for the content component of your choice, then drag and drop it onto the structure components.
   ...
   ![Drag the content component into the structure component](../../user/content/assets/content-components-drag.png){width="600" zoomable="yes"}

1. Adjust the component display using the **[!UICONTROL Settings]** and **[!UICONTROL Styles]** tabs on the right, or the context toolbar displayed in the canvas.

   For example, you can change the text style, padding, or margin of the component.

   ![Define the settings and styles for the content component](../../user/content/assets/content-components-settings-styles.png){width="600" zoomable="yes"}
...
![Display options for content component](../../user/content/assets/content-components-display-options.png){width="400" zoomable="yes"}
...
![Container content component styles](../../user/content/assets/content-components-container.png){width="600" zoomable="yes"}
...
When the button component is displayed in the canvas, the toolbar includes options for text formatting, as well as personalization and conditional variants. For more information about the editor toolbar options, see [Content component toolbars](#content-component-toolbars).

When you enter the button label text and set the formatting, the button resizes to accommodate the content. 

![Button component displayed with toolbar](../../user/content/assets/content-components-button.png){width="500" zoomable="yes"}

#### Set link options {#button-set-link-options}
...
1. Set the **[!UICONTROL Type]** for the link:
   ...
   * **[!UICONTROL External link]** - Choose this type to use a standard URL as the link destination.
      ...
      In **[!UICONTROL Url]**, enter the URL for the link destination. Click the _Personalize_ ( ![Personalize icon](../../user/assets/do-not-localize/icon-personalize.svg) ) icon to use a personalization token as a parameter in the URL.
      
      ![Define an external link for a button component](../../user/content/assets/component-button-link-options-external.png){width="200"}       
   ...
   * **Landing page** - Choose this type to select a published landing page in <!-- Journey Optimizer B2B Edition (_Beta_) or -->the connected Marketo Engage instance.
      ...
      For the **[!UICONTROL Landing Page]** option, select the published landing page. Click the _Select page_ icon ( ![Show links icon](../../user/assets/do-not-localize/icon-landing-page-select.svg) ) and [select the published landing page](./landing-pages.md#link-to-landing-page).
      
      ![Define a link to a landing page for a button component](../../user/content/assets/component-button-link-options-landing-page.png){width="200"}
...
* **[!UICONTROL Width]** - Use the toggle to set the width by pixels or percentage.
   ...
   * For a percentage width, use the slider to set the percentage value. The percentage determines the element size based on the content box of the containing block, which excludes padding and borders. For example, a value of 50 sets the element width to 50% of its containing block content width.
   ...
   ![Define line styling for a divider component](../../user/content/assets/component-divider-line-options.png){width="250"}
...
1. Select the component on the canvas and click the _Show the source code_ icon in the toolbar.
   ...
   ![Open the code editor to add the HTML](../../user/content/assets/content-components-html-show-code.png){width="450"}

1. Paste the HTML in the text box and click **[!UICONTROL Save]**.

   ![Edit HTML dialog](../../user/content/assets/content-components-html-edit-dialog.png){width="600" zoomable="yes"}   
...
![Image component displayed with toolbar](../../user/content/assets/content-components-image.png){width="400" zoomable="yes"}

#### Add the image asset {#add-image-asset}

Choose a method to add the image asset:

* **[!UICONTROL Select asset]** - Choose this type to browse and select an image asset from the [!DNL Journey Optimizer B2B Prime] Assets library.

  ![Browse the available image assets](./assets/dam-assets-internal-image-selected.png){width="700" zoomable="yes"}
...
* **[!UICONTROL Import media]** - Choose this type to select a file from your system and import it into the [!DNL Journey Optimizer B2B Prime] asset library.
   ...
   ![Import an image file to the asset library](../../user/content/assets/email-designer-image-upload.png){width="450"}
...
![Image settings](./assets/dam-assets-image-settings.png){width="250"}

#### Set link options {#image-set-link-options}
...
1. Set the **[!UICONTROL Type]** for the link:
   ...
   * **[!UICONTROL External link]** - Choose this type to use a standard URL as the link destination.
      ...
      ![Define an external link for an image component](../../user/content/assets/component-button-link-options-external.png){width="250"}       

   * **Landing page** - Choose this type to select a published landing page in <!-- Journey Optimizer B2B Edition (_Beta_) or -->the connected Marketo Engage instance.

      For the **[!UICONTROL Landing Page]** option, select the published landing page. Click the _Select page_ icon ( ![Show links icon](../../user/assets/do-not-localize/icon-landing-page-select.svg) ) and [select the published landing page](./landing-pages.md#link-to-landing-page).
      
      ![Define a link to a landing page for an image component](../../user/content/assets/component-button-link-options-landing-page.png){width="250"}

1. For **[!UICONTROL Label]**, optionally enter descriptive text for the image link.
...
* **[!UICONTROL Source]** - If you want to use your own image instead of the default, choose an image asset. You can select an image from the Assets library, or import an image file from your system. Refer to the [Image component information](#add-the-image-asset) for details about selecting and importing image assets.
* **[!UICONTROL Alt text]** - Enter the alt text for the displayed image.

![Settings for the expanded social media type](./assets/content-components-social-settings-for-type.png){width="250"}
...
1. If you want to override the default **[!UICONTROL Follow up type]** for the form, change the setting according to the requirements for your page or template.
   ...
   * **[!UICONTROL Landing page]** - Choose this option to select any [!DNL Journey Optimizer B2B Prime] or Marketo Engage landing page as the follow-up.
