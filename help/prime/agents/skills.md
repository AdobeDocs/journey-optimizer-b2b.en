...
| Skill | What it does | Access | Product | Backend (data flow) |
|---|---|---|---|---|
| `scoring-studio` | List/get scoring models and build/publish them. | Read+Write | [!DNL Journey Optimizer B2B Prime] | Reads + writes [!DNL Journey Optimizer B2B Prime] (scoring service); reads [!DNL Marketo Engage] lead fields/activity types |
