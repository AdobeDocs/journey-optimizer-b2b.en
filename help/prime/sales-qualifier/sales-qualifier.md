...
feature_v2:
  - id: abf46024-b86e-4240-96ee-3f23636dfc27
    internal-label: Outbound Workflows
  - id: ace0d1fc-8e69-4e6a-a442-37fc40985eea
    internal-label: Account Qualification Agent
...
Sales Qualifier is included with [!DNL Journey Optimizer B2B Prime], but it is a separate app within the Adobe Experience Platform.

![Sales Qualifier home screen](../../user/agents/assets/home-screen.png){width="800" zoomable="yes"}
...
![Prospects table displaying lead status and last activity for prospect management](../../user/agents/assets/prospects.png){width="800" zoomable="yes"}
...
![Outbound workflow Overview tab](../../user/agents/assets/outbound-workflow-overview.png){width="800" zoomable="yes"}
...
1. Choose **[!UICONTROL Start from scratch]** to write your own goal, or **[!UICONTROL Start from template]** to use a saved template.
   ...
   ![Create outbound workflow Start from scratch](../../user/agents/assets/outbound-workflow-create-start-from-scratch.png){width="700" zoomable="yes"}
...
1. Click the down arrow to display the **[!UICONTROL Add a filter]** list and select a filter to apply.
   ...
   ![Create outbound workflow Targeting filters](../../user/agents/assets/outbound-workflow-create-targeting-filter-list.png){width="700" zoomable="yes"}   

1. Set values for the filter.

1. Add more filters if you need to narrow the audience.

   ![Create outbound workflow Targeting added filters with values](../../user/agents/assets/outbound-workflow-create-targeting-filters-values.png){width="600" zoomable="yes"} 
...
![Outbound workflow generated touchpoint cadence and prompts](../../user/agents/assets/outbound-workflow-create-touchpoints.png){width="700" zoomable="yes"} 
...
![Outbound workflow settings](../../user/agents/assets/outbound-workflow-create-settings.png){width="700" zoomable="yes"} 
...
![Outbound workflow add prospects](../../user/agents/assets/outbound-workflow-create-add-prospects.png){width="700" zoomable="yes"}
...
![Outbound workflow review generated emails](../../user/agents/assets/outbound-workflow-create-review-generated-emails.png){width="700" zoomable="yes"}
...
![Outbound workflow generated email AI reasoning](../../user/agents/assets/outbound-workflow-create-review-generated-email-reasoning.png){width="600" zoomable="yes"}
...
1. In the email editor, click **[!UICONTROL Generate with AI]**.
   ...
   ![Outbound workflow generated email refinement with AI](../../user/agents/assets/outbound-workflow-create-review-generated-email-edit-regenerate.png){width="600" zoomable="yes"}
...
![Outbound workflow select and approve prospects](../../user/agents/assets/outbound-workflow-create-approve-enroll-prospects.png){width="700" zoomable="yes"}
...
![Tasks page showing the task queue and detail panel](../../user/agents/assets/tasks.png){width="800" zoomable="yes"}
...
1. In the left navigation, expand **[!UICONTROL Administration]** and select **[!UICONTROL Integrations]**.
   ...
   ![Integrations page with Salesforce and Dynamics connection cards](../../user/agents/assets/integrations-crm-connections.png){width="800" zoomable="yes"}   
...
![Integrations - Knowledge Center](../../user/agents/assets/integrations-knowledge-center.png){width="700" zoomable="yes"} 
...
![Email settings tab showing email connection options and email signature configuration](../../user/agents/assets/email-settings.png)
