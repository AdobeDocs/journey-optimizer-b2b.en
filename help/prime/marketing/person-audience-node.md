...
1. Use one of the following audience configuration options for the person audience:
   ...
   * **[!UICONTROL Event audience]** - Use an event audience define the journey audience based on qualifying events. Define audience members using person profile filtering and trigger journey entry using event criteria.

## Define an event audience

Add when information comes from PM.
