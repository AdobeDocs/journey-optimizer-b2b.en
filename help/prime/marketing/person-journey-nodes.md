...
After you create a person journey, use the tools in the canvas to add the audience and build out the journey using nodes. The journey canvas provides a visual design space, where you can build your multistep B2B marketing use cases.
